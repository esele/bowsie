#pragma once
inline int argmin(int val)
{
	return val;
}

template<typename... Args> inline int argmin(int arg1, const Args&... args)//if this is functional programming, I don't want to know more about it.
{
	int i=argmin(args...);
